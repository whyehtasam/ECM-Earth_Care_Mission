...
<head>
    ...
    <title>Event-flexbox</title>
    <link rel="stylesheet" href="<?php echo base_url(); ?>application/asset/css/event-flexbox.css">
    ...
    <div class="wrapper">
        ...
        <div id="flex-container">
            ...
            <div class="flipbox">
                <div class="flipbox-inner">
                    <div class="flipbox-front">
                        <img src="/ECM/application/asset/css/images/event1.jpg" alt="picture" class="img-radius">
                        <div>
                            <p class="over-text">Charity</p>
                        </div>
                    </div>
                    <div class="flipbox-back">
                        
                        <h3><u>Charity</u></h3>
                        <p class="p-front">Our charities have worked extensively for almost two decades to reach out and
                            rehabilitate students from underprivileged sections of the society and provide
                            them a better future for themselves and to be an asset for the nation.<a
                                href="#charity">...Read more</a></p>
                        <!--modal box-->
            ...
            <div class="flipbox">
                <div class="flipbox-inner">
                    <div class="flipbox-front">
                        <img src="/ECM/application/asset/css/images/event2.jpg" alt="picture" class="img-radius">
                        <div>
                            <p class="over-text">Donations</p>
                        </div>
                    </div>
                    <div class="flipbox-back">
                        <h3><u>Donation</u></h3>
                        <p class="p-front">Givng is not just about make a donation , it's about making a difference.
                            You can help a child escape from the bonds of poverty through our donation
                            system. The child receives education, healthcare as well as
                            nutritional support through every phase of
                            his/her young life<a href="#Donation">...Read more</a></p>
                    </div>
                </div>
            </div>
            ...
            <div class="flipbox">
                <div class="flipbox-inner">
                    <div class="flipbox-front">
                        <img src="/ECM/application/asset/css/images/event3.jpg" alt="picture" class="img-radius">
                        <div>
                            <p class="over-text">Helping the needy</p>
                        </div>
                    </div>
                    <div class="flipbox-back">
                        <h3><u>Helping the needy</u></h3>
                        <p class="p-front">The organisation is helping deprived children get a chance at a fulfilling
                            childhood by providing them quality learning opportunities, access to
                            healthcare, protection from abuse and harm and relief and rehabilitation during
                            disasters and emergencies<a href="#Helping">...Read more</a></p>
                    </div>
                </div>
            </div>
            ...
            <div class="flipbox">
                <div class="flipbox-inner">
                    <div class="flipbox-front">
                        <img src="/ECM/application/asset/css/images/event4.jpg" alt="picture" class="img-radius">
                        <div>
                            <p class="over-text">Medical camp</p>
                        </div>
                    </div>
                    <div class="flipbox-back">
                        <h3><u>Medical Camp</u></h3>
                        <p class="p-front">Our Foundation recognizes the challenges of the underprivileged to access
                            primar healthcare.We therefore organize free multispecialty health camps across
                            geographies which includes a thorough check up by a doctor, distribution of free medicines.<a href="#Medical">...Read more</a></p>
                    </div>
                </div>
            </div>
            ...
            <div class="flipbox">
                <div class="flipbox-inner">
                    <div class="flipbox-front">
                        <img src="/ECM/application/asset/css/images/event5.jpg" alt="picture" class="img-radius">
                        <div>
                            <p class="over-text">Educatonal camp</p>
                        </div>
                    </div>
                    <div class="flipbox-back">
                        <h3><u>Educational Camp</u> </h3>
                        <p class="p-front">Our Foundation's educational programme
                            which works for education for underprivileged children who are under difficult
                            circumstances, such as child labour, children of poorest of the parents,
                            children inflicted and affected with HIV/AIDS, disaster struck children and slum children.<a
                                href="#Educational">...Read more</a>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="flipbox">
                <div class="flipbox-inner">
                    <div class="flipbox-front">
                        <img src="/ECM/application/asset/css/images/event6.jpg" alt="picture" class="img-radius">
                        <div>
                            <p class="over-text">Food & Supplies</p>
                        </div>
                    </div>
                    <div class="flipbox-back">
                        <h3><u>Food and supplies</u><u></u> </h3>
                        <p class="p-front">The organisation has been working relentlessly to
                            provide, social and economic aid to communities in the lower rungs of the
                            society with a special focus on underprivileged kids
                            we had taken the initiative to provide dry rations to those who are affected and in need.<a href="#Food">...Read
                                more</a></p>
                    </div>
                </div>
            </div>
